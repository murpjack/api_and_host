(function (global, factory) {
  ...
  (global = global || self, global.Fluture = factory(global.sanctuaryTypeIdentifiers, global.sanctuaryShow));
}(this, (function (type, show) { 'use strict';

  type = type && Object.prototype.hasOwnProperty.call(type, 'default') ? type['default'] : type;
  show = show && Object.prototype.hasOwnProperty.call(show, 'default') ? show['default'] : show;
  ...
  function isParallel(x){
    return x instanceof ConcurrentFuture || type(x) === $$type$1;
  }
